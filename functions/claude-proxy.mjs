// Netlify Function v1 format (most compatible)
export async function handler(event) {
  ...
  try {
    ...
    if (!response.ok) {
      return { statusCode: response.status, headers, body: JSON.stringify({ error: data.error?.message || 'API error', details: data }) };
    }
