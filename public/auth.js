/* Mizan Mind — auth.js */
/* GoTrue-JS v1.0.1 inline + Auth Logic */
...
function authShowMsg(text,type){
  ...
  el.style.background=type==='err'?'rgba(239,68,68,.1)':type==='ok'?'rgba(34,197,94,.1)':'var(--acd)';
  el.style.border=`1px solid ${type==='err'?'rgba(239,68,68,.25)':type==='ok'?'rgba(34,197,94,.25)':'rgba(var(--ac-rgb,59 130 246)/.2)'}`;
